...
sh_demo.categories.get("5lap - Ultra Shortcut").push(...[
    ...
    ["MyntiFresh", "16.879", "https://youtu.be/RWFI2Yd44c4?si=V5FVTyq8zlA2dKqj"]
]);
...
mm_beta.categories.get("5lap - Shortcut").push(...[
    ["Rinify", "2:51.767", "https://www.youtube.com/watch?v=tiCZaTp_OTU"]
]);

mm_beta.categories.get("Flap - Shortcut").push(...[
    ["Rinify", "32.717", "https://youtu.be/tiCZaTp_OTU?si=wIZkVntme5fw0aIg&t=147"]
]);
...
sh_beta.categories.get("5lap - Shortcut").push(...[
    ["Rinify", "2:49.067", "https://www.youtube.com/watch?v=-eab8pW1zTw"]
]);
